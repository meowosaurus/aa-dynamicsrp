...
# - absolute urls eg 'http://dynamicsrp.com/dashboard'
...
INSTALLED_APPS += ["dynamicsrp"]

# Register an application at https://developers.eveonline.com for Authentication
# & API Access and fill out these settings. Be sure to set the callback URL
# to https://dynamicsrp.com/sso/callback substituting your domain for dynamicsrp.com
...
# Set the default from email to something like 'noreply@dynamicsrp.com'
