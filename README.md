# dynamicsrp Plugin App for Alliance Auth (GitHub Version)

This is an dynamicsrp plugin app for [Alliance Auth](https://gitlab.com/allianceauth/allianceauth)
...
_(These badges are dynamicsrps, you can and should replace them with your own)_

For the GitLab version of this dynamicsrp app, please have a look over here, Erik
Kalkoken was so friendly to provide it » [Alliance Auth dynamicsrp App (GitLab Version)](https://gitlab.com/ErikKalkoken/allianceauth-dynamicsrp-plugin)


---

<!-- TOC -->
* [dynamicsrp Plugin App for Alliance Auth (GitHub Version)](#dynamicsrp-plugin-app-for-alliance-auth-github-version)
  * [Features](#features)
...
To use this dynamicsrp as a basis for your own development, just fork this repo and then
...
```bash
git clone https://github.com/YourName/aa-dynamicsrp-plugin.git aa-your-app-name
cd aa-your-app-name
rm -rf .git
git init
pre-commit install
...
additional apps that might also be called dynamicsrp.

Here is an overview of the places that you need to edit to adopt the name.

Easiest is to just find & replace `dynamicsrp` with your new app name in all files
listed below.
...
|------------------------------------------|----------------------------------------------------------------------------------------|
| `./dynamicsrp/`                             | Folder name                                                                            |
| `./dynamicsrp/static/dynamicsrp/`              | Folder name                                                                            |
| `./dynamicsrp/templates/dynamicsrp/`           | Folder name                                                                            |
| `./setup.cfg`                            | Update module name for version import, update package name, update title, author, etc. |
| `./dynamicsrp/apps.py`                      | App name                                                                               |
| `./dynamicsrp/__init__.py`                  | App name                                                                               |
| `./dynamicsrp/auth_hooks.py`                | Menu hook config incl. icon and label of your app's menu item appearing in the sidebar |
| `./dynamicsrp/models.py`                    | App name                                                                               |
| `./dynamicsrp/urls.py`                      | App name                                                                               |
| `./dynamicsrp/views.py`                     | Permission name and template path                                                      |
| `./dynamicsrp/templates/dynamicsrp/base.html`  | Title of your app to be shown in all views and as title in the browser tab             |
| `./dynamicsrp/templates/dynamicsrp/index.html` | Template path                                                                          |
